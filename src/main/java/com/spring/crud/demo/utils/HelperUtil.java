...
public class HelperUtil {
    ...
    public static Supplier<List<Student>> studentSupplier = () ->
        Arrays.asList(
            ...
            Student.builder().rollNo(2).firstName("Rahul").lastName("Ghadage").marks(
                950.0f).build(),
            ...
            Student.builder().rollNo(6).firstName("Shahrukh").lastName("Khan").marks(
                800.0f).build(),
            Student.builder().rollNo(7).firstName("Ranbir").lastName("Kapoor").marks(
                900.0f).build(),
            Student.builder().rollNo(8).firstName("Ranveer").lastName("Singh").marks(
                800.0f).build(),
    ...
    public static Supplier<List<SuperHero>> superHeroesSupplier = () ->
        Arrays.asList(
            SuperHero.builder().name("Wade").superName("Deadpool").profession("Street fighter").age(
                28).canFly(false).build(),
            SuperHero.builder().name("Bruce").superName("Hulk").profession("Doctor").age(50).canFly(
                false).build(),
            SuperHero.builder().name("Steve").superName("Captain America").profession("Solder").age(
                120).canFly(false).build(),
            SuperHero.builder().name("Tony").superName("Iron Man").profession("Business man").age(
                45).canFly(true).build(),
            SuperHero.builder().name("Peter").superName("Spider Man").profession("Student").age(
                21).canFly(true).build()
        );
